...
CoreTasks = SC.Object.create({
  ...
  setPermissions: function() {
    ...
    switch(this.currentUser.get('role')) {
      case CoreTasks.USER_ROLE_MANAGER:
        ...
        this.permissions.set('canEditUser', YES);
      ...
      case CoreTasks.USER_ROLE_TESTER:
        ...
        this.permissions.set('canEditUser', NO);
   ...
   */
  // FIXME: [SC] Beta: after multiple entities are deleted, pressing Save causes these entities to flash on screen one at a time!
