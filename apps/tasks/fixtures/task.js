...
Tasks.Task.FIXTURES = [
	...
	priority: Orion.Tasks.Task.HIGH,
	status: Orion.Tasks.Task.DONE,
	effort: "1",
	submitter: "Manager1",
	assignee: "Developer1" },
	...
	description: "A long paragraph describing what this task is about and capturing any release notes that need to be conveyed to Testers",
	priority: Orion.Tasks.Task.HIGH,
	status: Orion.Tasks.Task.ACTIVE,
	effort: "0.25",
	submitter: "Manager1",
	assignee: "Developer1" },
	...
	description: "A long paragraph describing what this task is about and capturing any release notes that need to be conveyed to Testers",
	priority: Orion.Tasks.Task.HIGH,
	status: Orion.Tasks.Task.AT_RISK,
	submitter: "Manager1",
	assignee: "Developer1" },
	...
	description: "A long paragraph describing what this task is about and capturing any release notes that need to be conveyed to Testers",
	priority: Orion.Tasks.Task.HIGH,
	status: Orion.Tasks.Task.PLANNED,
	effort: "5",
	submitter: "Tester1",
	assignee: "Developer2" },
	...
	description: "A long paragraph describing what this task is about and capturing any release notes that need to be conveyed to Testers",
	priority: Orion.Tasks.Task.HIGH,
	status: Orion.Tasks.Task.PASSED,
	effort: "1",
	submitter: "Tester2",
	assignee: "Developer3" },
	...
	description: "A long paragraph describing what this task is about and capturing any release notes that need to be conveyed to Testers",
	priority: Orion.Tasks.Task.HIGH,
	status: Orion.Tasks.Task.MEDIUM,
	effort: "4h",
	submitter: "Manager1",
	assignee: "Developer4" },
	...
	description: "A long paragraph describing what this task is about and capturing any release notes that need to be conveyed to Testers",
	priority: Orion.Tasks.Task.MEDIUM,
	status: Orion.Tasks.Task.PLANNED,
	submitter: "Manager1" }
